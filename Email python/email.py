...
class MailApp:
    def __init__(self, master):
        self.master = master
        master.title("Mail Application - Created by Anisha Reddy")
        tkinter.Tk.config(master, background="lightgray")

        # Create the UI
        self.from_label = tk.Label(master, text="From:       ", background="white")
        ...
        self.pass_label = tk.Label(master, text="Password:       ", background="white")
        ...
        self.to_label = tk.Label(master, text="To:        ", background="white")
        ...
        self.subject_label = tk.Label(master, text="Subject:     ", background="white")
        ...
        self.body_label = tk.Label(master, text="Body:     ", background="white")
        ...
        self.send_button = tk.Button(master, text="Send", command=self.send_mail, width=16,
                                     background="blue", foreground="White", font=10)
